...
// ************************************************************************************************
// configuration class determines:
...
//                .defaultSuccessUrl("/ads") // user's home page, it can be any URL
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/", "/ads", "/posts", "/sign-up", "/login") // anyone can see the home and the ads pages
                .permitAll()
                /* Pages that require authentication */
                .and()
                .authorizeRequests()
//  COMMA SEPARATE PAGES WHICH REQUIRE AUTHENTICATION:
                .antMatchers(
